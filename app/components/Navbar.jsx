 ...
 const closeMenu = () => {
  ...
  return (
    ...
    <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll? 
      "bg-white text-black opacity-95 backdrop-blur-lg shadow-sm font-normal": "" }`}>
      <a href='#top'>
        <h1 className='font-serif font-semibold text-3xl'>Ammar<span className='text-[#EC1552] text-4xl '> .</span> </h1>
      </a>
